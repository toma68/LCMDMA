<template>
  <v-container>
    ...
    <br>
    <br>
    <h1 className="text-center">{{ prestataire.nomEntreprise }}</h1>
    <br>
    <v-row>
      <v-col className="col-6">
        <v-img
            width="auto"
      ...
      <v-col className="col-6">
        <v-card>
          ...
          <br>
          <h3 className="mx-3">Le mot du prestataire : </h3>
          <PrestataireComponent :prestataire="prestataire"/>
          <br>
          <h3 className="mx-3">Mes activités : </h3>
